...
void page_manager_create(lv_obj_t* container) {
    ...
    page_master_create_pages(TABVIEW);
}
...
lv_obj_t* page_manager_create_tabview(lv_obj_t* container) {
    ...
    page_master_tabview_set_top_bar_bg(tabview);
...
lv_obj_t* page_master_tabview_create_tab(lv_obj_t* tabview, const char* tab_name) {
    ...
    page_master_tabview_set_tab_button_styles(lv_obj_get_child(tab_bar, tab_button_index));
...
void page_master_create_pages(lv_obj_t* tabview) {
    lv_obj_t* vehicle_tab = page_master_tabview_create_tab(tabview, "Vehicle");
    lv_obj_t* ultrasonic_sensor_tab = page_master_tabview_create_tab(tabview, "Ultrasonic Sensor");

    page_vehicle_create(vehicle_tab);
    page_sensor_create(ultrasonic_sensor_tab);
