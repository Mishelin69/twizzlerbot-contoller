...
#include "../include/waveshare_rgb_lcd_port.h"
#include "driver/i2c_types.h"
#include "esp_lcd_io_i2c.h"

i2c_master_bus_handle_t i2c_bus_handle = NULL;
i2c_master_dev_handle_t ch422g_dev_0x24 = NULL;
i2c_master_dev_handle_t ch422g_dev_0x38 = NULL;
...
static esp_err_t i2c_master_init(void)
{
    ...
    return i2c_new_master_bus(&i2c_conf, &i2c_bus_handle);
}
...
void waveshare_esp32_s3_touch_reset()
{
    ...
    i2c_master_transmit(ch422g_dev_0x24, &write_buf, 1, I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);

    // Reset the touch screen. It is recommended to reset the touch screen before using it.
    write_buf = 0x2C;
    i2c_master_transmit(ch422g_dev_0x38, &write_buf, 1, I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
...
esp_err_t waveshare_esp32_s3_rgb_lcd_init()
{
    ...
    ESP_ERROR_CHECK(i2c_master_bus_add_device(i2c_bus_handle, &dev_cfg_24, &ch422g_dev_0x24));
    ...
    ESP_ERROR_CHECK(i2c_master_bus_add_device(i2c_bus_handle, &dev_cfg_38, &ch422g_dev_0x38));
    ...
    esp_lcd_rgb_panel_event_callbacks_t cbs = {
        ...
        .on_frame_buf_complete = rgb_lcd_on_vsync_event, // Callback for bounce frame finish
#else
...
esp_err_t wavesahre_rgb_lcd_bl_on()
{
    ...
    uint8_t write_buf = 0x01;
    i2c_master_transmit(ch422g_dev_0x24, &write_buf, 1, I2C_MASTER_TIMEOUT_MS);

    //Pull the backlight pin high to light the screen backlight 
    write_buf = 0x1E;
    i2c_master_transmit(ch422g_dev_0x38, &write_buf, 1, I2C_MASTER_TIMEOUT_MS);
    return ESP_OK;
}
